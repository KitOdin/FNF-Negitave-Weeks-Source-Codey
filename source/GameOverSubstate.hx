...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	function JoshuaCrap()
	{
		if (PlayState.SONG.song == "Colors")
		{
			if (FlxG.random.bool(0.1))
			{
				FlxG.sound.play('assets/sounds/gameover/Jo_Chug' + TitleState.soundExt);
			}
			else
			{
				FlxG.sound.play('assets/sounds/gameover/Jo_' + FlxG.random.int(1, 15) + TitleState.soundExt);
			}
		}
	}
}
