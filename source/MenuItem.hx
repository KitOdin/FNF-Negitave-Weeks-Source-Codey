...
class MenuItem extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, weekNum:Int = 0)
	{
		...
		var tex = FlxAtlasFrames.fromSparrow('assets/images/ui/weekAssets.png', 'assets/images/ui/weekAssets.xml');
		...
		week.animation.addByPrefix('week7', "WEEK Minus1 select", 24);
		week.animation.addByPrefix('week8', "week Minus2", 24);
		add(week);
