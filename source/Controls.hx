...
class Controls extends FlxActionSet
{
	...
	var _secretLvl = new FlxActionDigital(Action.SECRET_LEV);
	...
	public var SECRET_LEV(get, never):Bool;

	inline function get_SECRET_LEV()
	return _secretLvl.check();
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.SECRET_LEV, [H]);
			case Duo(true):
